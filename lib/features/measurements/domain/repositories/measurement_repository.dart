...
abstract interface class MeasurementRepository {
  ...
  Future<Either<Failure, void>> addMeasurement({required MeasurementEntry measurementEntry});
  Future<Either<Failure, void>> toggleMyMeasurementStatus({required String id});
  Future<Either<Failure, void>> updateMyMeasurementReminderSettings({required MyMeasurements myMeasurement});

  Future<Either<Failure, Visibility>> getMeasurementVisibility({required String measurementId});
